...
public class TutorController {
    ...
    @ApiOperation(position = 1, value = "튜터 - 이메일 중복 확인", notes = "code: 1(중복 메일 없음), -1(중복 메일 존재)", tags="튜터")
    ...
    @ApiOperation(position = 1, value = "대학교 리스트", notes = "", tags = "튜터")
...
//    }
    ...
    @ApiOperation(position = 7, value = "랜덤 매칭된 튜티 정보 조회", notes = "", tags = "튜터")
    public Tutee getRandomMatchedTutee() {
        return tutorService.getRandomMatchedTutee();
    }

    @RequestMapping(value = "/apply", method = RequestMethod.POST)
    @ApiOperation(position = 7, value = "신청하기", notes = "", tags = "튜터")
    ...
    @ApiOperation(position = 7, value = "수락하기", notes = "", tags = "튜터")
    ...
    @ApiOperation(position = 7, value = "거절하기", notes = "", tags = "튜터")
